...
Pie <- gvisPieChart(ResulVersionesMundo,options=list(width="800px", height="600px"))
plot(Pie)
```
...
```{r Mapa_Vulns_Paises, out.width = "800px", echo = TRUE, results='asis', tidy=FALSE}
MapaRiesgo <- gvisGeoChart(ResulPaisesRiesgoTotal, locationvar = "pais", colorvar = "TotalRiesgo", options=list(width="800px", height="600px", region='150', colorAxis="{colors:['yellow', 'red']}",backgroundColor="lightblue"))
plot(MapaRiesgo)
```
